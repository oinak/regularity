...
var Regularity = function() {
    ...
    var _interpret = function() {
        ...
        switch (arguments.length) {
            case 2:
                return _numberedConstraint(arguments[0],arguments[1]);
            case 1:
                return _patternedConstraint(arguments[0]);
            default:
                throw new Error('_interpret: wrong number of arguments: got ' + arguments.length + ', expected 1 or 2');
        }
    };
...
/* PUBLIC OBJECT API: */
    ...
    this.startWith = function() {
        ...
        return _appendPatternChunk('^%s', _interpret(arguments));
    };

    // Append a pattern to the end (Also aliased to then)
    this.append = function() {
        return _appendPatternChunk(_interpret(arguments));
    };
    ...
    this.oneOf = function() {
        ...
        return _appendPatternChunk('[%s]', choices);
    };
    ...
    this.between = function(range, pattern) {
        ...
        return _appendPatternChunk(_makeRangedPattern(_interpret(pattern), beginning, end));
    };
