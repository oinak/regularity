...
var Regularity = function() {
    ...
    this.maybe = function() {
        _appendPatternChunk(quantify.zeroOrOne('%s'), _interpret(arguments));
    ...
    this.zeroOrMore = function() {
        _appendPatternChunk(quantify.zeroOrMore('%s'), _interpret(arguments));

        return this;
    };

    this.oneOrMore = function() {
        _appendPatternChunk(quantify.oneOrMore('%s'), _interpret(arguments));
